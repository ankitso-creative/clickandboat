...
<section class="location_filter_mobile">
    ...
    <div class="row mob_filter_two">
        ...
        <div class="col-md-4">
        <button type="button" class="btn filter_btn"><i class="fa-solid fa-sliders"></i> Filter</button>
        </div>
    </div>
    </div>
</section>
                                ...
                                <a
                                    ...
                                    <div class="location_inner_main_box">
                                        <div class="location_inner_text">
                                            <h3>{{ $result->city }}</h3>
                                            <p class="location_pera">{{ $result->type }} {{ $result->manufacturer }}
                                                {{ $result->model }} sport 30 (2023)</p>
