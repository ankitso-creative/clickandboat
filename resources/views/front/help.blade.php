                ...
                <div id="accordionExample" class="shadow accordion">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">[MyboatBooker] is a peer-to-peer boat rental platform that connects boat owners with renters. Owners list their boats, and renters can book them for a specified date & time.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Browse marinas, choose your boat, select a desired date and time, and complete the booking request directly with the owner.  The boat owner will review your request, give you a price and once approved, you'll receive a confirmation. Follow the steps to pay at checkout.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 3 -->
                    <div class="card">
                        ...
                        <div id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Requirements vary based on boat type. Some boats require a valid boating license and some without. While others can be rented with a licensed captain. Check the listing details or contact the owner for specifics.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 4 -->
                    <div class="card">
                        ...
                        <div id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Yes! Many boat owners offer rentals with a captain, so you can enjoy the water without needing to operate the boat yourself.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 5 -->
                    <div class="card">
                        ...
                        <div id="collapseFive" aria-labelledby="headingFive" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Pricing depends on the boat type, rental duration, and location. Each boat owner sets their rates, which are displayed on the listing.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 6 -->
                    <div class="card">
                        ...
                        <div id="collapseSix" aria-labelledby="headingSix" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Some rentals may include extra charges for fuel, cleaning, captain services, or optional add-ons like water sports equipment. Check the listing for details.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 7 -->
                    <div class="card">
                        ...
                        <div id="collapseSeven" aria-labelledby="headingSeven" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Payments are made securely through our platform using a credit/debit card or other available payment options. We do not support cash transactions.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 8 -->
                    <div class="card">
                        ...
                        <div id="collapseEight" aria-labelledby="headingEight" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Yes, we use encrypted payment processing to ensure your transactions are safe and secure.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 9 -->
                    <div class="card">
                        ...
                        <div id="collapseNine" aria-labelledby="headingNine" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Cancellation policies vary by boat owner. Some offer full refunds if canceled within a certain timeframe, while others have stricter policies. The policy is listed on each boat’s page.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                     <!-- Accordion item 10 -->
                     <div class="card">
                        ...
                        <div id="collapseTen" aria-labelledby="headingTen" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">If unsafe weather conditions prevent your rental, you can reschedule or receive a refund per the owner’s policy.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 11 -->
                    <div class="card">
                        ...
                        <div id="collapseEleven" aria-labelledby="headingEleven" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Each listing will specify what’s included, such as life jackets, fuel, and equipment. Some boats may have optional add-ons like water skis or fishing gear.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 12 -->
                    <div class="card">
                        ...
                        <div id="collapseTwelve" aria-labelledby="headingTwelve" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Most boat rentals allow food and drinks, but check with the owner for any restrictions (e.g., alcohol policies).</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 13 -->
                    <div class="card">
                        ...
                        <div id="collapseThirteen" aria-labelledby="headingThirteen" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Some boat owners allow pets, while others do not. Check the listing details or contact the owner to confirm.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 14 -->
                    <div class="card">
                        ...
                        <div id="collapseFourteen" aria-labelledby="headingFourteen" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">Some owners include fuel in the rental price, while others require renters to refill the tank. Check the boat listing for specific instructions.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 15 -->
                    <div class="card">
                        ...
                        <div id="collapseFifteen" aria-labelledby="headingFifteen" data-parent="#accordionExample"
                            ...
                            <div class="card-body">
                                <p class="m-0">
                                We offer optional rental insurance to protect both renters and owners. Some owners may require proof of insurance before confirming your booking.   </p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 16 -->
                    <div class="card">
                        ...
                        <div id="collapseSixteen" aria-labelledby="headingSixteen" data-parent="#accordionExample"
                            ...
                            <div class="card-body">
                                <p class="m-0">
                                Always wear a life jacket, follow local boating regulations, and adhere to any guidelines set by the boat owner.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 17 -->
                    <div class="card">
                        ...
                        <div id="collapseSeventeen" aria-labelledby="headingSeventeen" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">
                                Call local emergency services immediately if needed. Also, inform the boat owner and our support team.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 18 -->
                    <div class="card">
                        ...
                        <div id="collapseEighteen" aria-labelledby="headingEighteen" data-parent="#accordionExample"
                            ...
                            <div class="card-body">
                                <p class="m-0">
                                Simply create an account, upload photos, set your pricing, and provide details about your boat. Once your listing is live, renters can book your boat.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 19 -->
                    <div class="card">
                        ...
                        <div id="collapseNineteen" aria-labelledby="headingNineteen" data-parent="#accordionExample"
                            ...
                            <div class="card-body">
                                <p class="m-0">
                                Once a rental is completed, payments are processed securely and transferred to your account within a few days.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 20 -->
                    <div class="card">
                        ...
                        <div id="collapseTwenty" aria-labelledby="headingTwenty" data-parent="#accordionExample"
                            ...
                            <div class="card-body">
                                <p class="m-0">
                                We offer optional insurance and security deposit options to help protect against damages. You can also set your own rental terms to safeguard your boat.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 21 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentyone" aria-labelledby="headingTwentyone" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">
                                We offer a wide range of boats, including pontoons, sailboats, motorboats, kayaks, and luxury yachts. You can browse the full list of available boats and choose the one that best suits your needs.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 22 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentytwo" aria-labelledby="headingTwentytwo" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">
                                Make sure to bring any necessary identification, your boating license (if required), and personal items like sunscreen, food, and water. Check with the boat owner for any specific requirements.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 23 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentythree" aria-labelledby="headingTwentythree" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">
                                If you experience any problems, first contact the boat owner. If further assistance is needed, reach out to Click & Boat customer support for help.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 24 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentyFour" aria-labelledby="headingTwentyFour" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">
                                You can reach MyBoatBooker’s support team through the help center on the website, by email or submit a request form.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 25 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentyFive" aria-labelledby="headingTwentyFive" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                If you need to modify your booking, contact the boat owner as soon as possible. Some changes may require approval, and additional fees may apply.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 26 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentySix" aria-labelledby="headingTwentySix" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                Yes, My Boat Booker uses secure payment methods and verifies boat owners to ensure a trustworthy rental experience. Always communicate and make payments through the platform for added security.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                     <!-- Accordion item 27 -->
                     <div class="card">
                        ...
                        <div id="collapseTwentySeven" aria-labelledby="headingTwentySeven" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                Yes, you must create an account to book a boat, send messages to boat owners, and manage your reservations. Signing up is free and only takes a few minutes</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 28 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentyeight" aria-labelledby="headingTwentyeight" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                If you’re eligible for a refund, My Boat Booker processes it as soon as the cancellation is confirmed. Refunds may take 3-10 business days to appear, depending on your payment provider.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 29 -->
                    <div class="card">
                        ...
                        <div id="collapseTwentynine" aria-labelledby="headingTwentynine" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                It is free to list your boat on My Boat Booker.. The platform only charges a commission when a booking is successfully completed.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 30 -->
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThirtyone" aria-labelledby="headingThirtyone" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                Most rentals follow a “full-to-full” fuel policy, meaning you receive the boat with a full tank and must return it with a full tank. Be sure to check with the owner before departure.</p>
                            </div>
                        </div>
                    </div><!-- End -->
                    <!-- Accordion item 32 -->
                    <div class="card">
                        ...
                        <div id="collapseThirtytwo" aria-labelledby="headingThirtytwo" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body">
                                <p class="m-0">    
                                Yes! My Boat Booker verifies boat owners and secures all transactions. To ensure a safe experience:</p>
                                <ul>
