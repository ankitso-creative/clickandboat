...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title">Manage Language
                <span style="float: right;">
                    <a href="{{ route('admin.add-language')}}" class="btn green"><i class="fa fa-plus"></i> &nbsp;New</a>
                </span>
            </h1>
            @if(session('success'))
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                    <i class="fa fa-file-text-o"></i> Manage Language</div>
