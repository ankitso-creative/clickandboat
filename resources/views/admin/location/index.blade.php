        ...
        <div class="page-content">
            ...
            <h1 class="page-title">Manage Blogs
                <span style="float: right;">
                    <a href="{{ route('admin.location.create')}}" class="btn green"><i class="fa fa-plus"></i> &nbsp;New</a>
                </span>
            </h1>
                                ...
                                @if($results)
                                    @foreach ($results as $result)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.location.edit', $result->id) }}" class="btn btn-circle btn-icon-only btn-default tooltips" title = "Edit" href="javascript:;"> <i class="icon-note"></i></a>
                                                <a href="{{ route('admin.location.destroy', $result->id) }}" class="btn btn-circle btn-icon-only btn-default tooltips delete_row" title = "Delete" href="javascript:;"> <i class="icon-trash"></i></a>
                                            </td>
                                        </tr> 
                                    @endforeach
                                @else
