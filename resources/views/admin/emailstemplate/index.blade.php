                                ...
                                @if($results)
                                    @foreach ($results as $result)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $result->title }}</td>
                                            <td>
                                                <a href="{{ route('admin.emailtemplate.edit', $result->id) }}" class="btn btn-circle btn-icon-only btn-default tooltips" title = "Edit" href="javascript:;"> <i class="icon-note"></i></a>
                                            </td>
                                        </tr> 
                                    @endforeach
                                @else
