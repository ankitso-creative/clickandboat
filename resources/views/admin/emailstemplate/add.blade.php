...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <h1 class="page-title"> Manage Email: Add</h1>
            <div class="clear"></div>
            <div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" action="{{ route('admin.emailtemplate.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
                        <div class="portlet">
							<div class="form-body">
                                <div class="form-group">
									...
									<div class="col-sm-4">
										...
										<input name="who_receive" value="{{ old('who_receive') }}" class="form-control" type="text"> 
                                    </div>
									<div class="col-sm-12">
